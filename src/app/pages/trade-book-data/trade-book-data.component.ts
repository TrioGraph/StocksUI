...
import { createTradeBookDataForm } from '../../forms/angel-broking-forms';
import { AngelBrokingApiService } from '../../services/angel-broking-api.service';

@Component({selector:'app-trade-book-data',templateUrl:'./trade-book-data.component.html',styleUrls:['./trade-book-data.component.css']})
export class TradeBookDataComponent{
  form = this.fb.group(createTradeBookDataForm(this.fb).controls);
  ...
  submit(){this.api.postGeneric('trade-book-data', this.form.value).subscribe(r=>console.log(r));}
}
